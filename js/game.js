...
function updatingAllCells() {
  ...
  cell.forEach((item) => {
    if (item.classList.contains("cell-blink")) item.innerHTML = numbers;
  });
}
...
function bingoLogic() {
  ...
  //row1
  if (
    cell[0].classList.contains("cellIsSelected") &&
    cell[1].classList.contains("cellIsSelected") &&
    cell[2].classList.contains("cellIsSelected") &&
    cell[3].classList.contains("cellIsSelected") &&
    cell[4].classList.contains("cellIsSelected")
  )
    ++count;
  //row2
  if (
    cell[5].classList.contains("cellIsSelected") &&
    cell[6].classList.contains("cellIsSelected") &&
    cell[7].classList.contains("cellIsSelected") &&
    cell[8].classList.contains("cellIsSelected") &&
    cell[9].classList.contains("cellIsSelected")
  )
    ++count;
  //row3
  if (
    cell[10].classList.contains("cellIsSelected") &&
    cell[11].classList.contains("cellIsSelected") &&
    cell[12].classList.contains("cellIsSelected") &&
    cell[13].classList.contains("cellIsSelected") &&
    cell[14].classList.contains("cellIsSelected")
  )
    ++count;
  //row4
  if (
    cell[15].classList.contains("cellIsSelected") &&
    cell[16].classList.contains("cellIsSelected") &&
    cell[17].classList.contains("cellIsSelected") &&
    cell[18].classList.contains("cellIsSelected") &&
    cell[19].classList.contains("cellIsSelected")
  )
    ++count;
  //row5
  if (
    cell[20].classList.contains("cellIsSelected") &&
    cell[21].classList.contains("cellIsSelected") &&
    cell[22].classList.contains("cellIsSelected") &&
    cell[23].classList.contains("cellIsSelected") &&
    cell[24].classList.contains("cellIsSelected")
  )
    ++count;
...
boxController.addEventListener("click", (e) => {
  ...
  if (startGame.classList.contains("game-started")) bingoLogic();
});
